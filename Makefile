...
# Generated by qmake (2.01a) (Qt 4.8.7) on: So 12. Jan 02:23:22 2020
# Project:  bitcrystal-qt.pro
# Template: app
# Command: c:\Qt\4.8.7\bin\qmake -spec c:\Qt\4.8.7\mkspecs\win32-g++ USE_QRCODE=1 USE_UPNP=1 USE_IPV6=- CONFIG+=release -o Makefile bitcrystal-qt.pro
#############################################################################
...
Makefile: bitcrystal-qt.pro  c:/Qt/4.8.7/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.7/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.7\mkspecs\win32-g++ USE_QRCODE=1 USE_UPNP=1 USE_IPV6=- CONFIG+=release -o Makefile bitcrystal-qt.pro
